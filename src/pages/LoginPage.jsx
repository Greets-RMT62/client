        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 card-hover border border-white/20">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-gradient text-white py-3 px-4 rounded-xl font-semibold shadow-lg flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
